-- Fix Clinic RLS Policies - Replace auth.users with JWT email
...
DROP POLICY IF EXISTS "Authenticated users can view active clinics" ON clinic;

-- Authenticated users (patients/therapists) can view active clinics for selection
