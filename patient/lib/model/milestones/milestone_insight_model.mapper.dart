...
class MilestoneInsightModelMapper
  ...
  static const Field<MilestoneInsightModel, String> _f$title =
      Field('title', _$title);
  static String _$category(MilestoneInsightModel v) => v.category;
  static const Field<MilestoneInsightModel, String> _f$category =
      Field('category', _$category);
  static String _$status(MilestoneInsightModel v) => v.status;
  static const Field<MilestoneInsightModel, String> _f$status =
      Field('status', _$status);
  static String _$description(MilestoneInsightModel v) => v.description;
  static const Field<MilestoneInsightModel, String> _f$description =
      Field('description', _$description);
  static String _$evidence(MilestoneInsightModel v) => v.evidence;
  static const Field<MilestoneInsightModel, String> _f$evidence =
      Field('evidence', _$evidence);
...
mixin MilestoneInsightModelMappable {
  ...
  MilestoneInsightModelCopyWith<MilestoneInsightModel, MilestoneInsightModel,
      MilestoneInsightModel> get copyWith => _MilestoneInsightModelCopyWithImpl<
          MilestoneInsightModel, MilestoneInsightModel>(
      this as MilestoneInsightModel, $identity, $identity);
  @override
  String toString() {
    return MilestoneInsightModelMapper.ensureInitialized()
        .stringifyValue(this as MilestoneInsightModel);
  }

  @override
  bool operator ==(Object other) {
    return MilestoneInsightModelMapper.ensureInitialized()
        .equalsValue(this as MilestoneInsightModel, other);
  }

  @override
  int get hashCode {
    return MilestoneInsightModelMapper.ensureInitialized()
        .hashValue(this as MilestoneInsightModel);
  }
}
...
class MilestoneAnalysisModelMapper
  ...
  static String _$progressSummary(MilestoneAnalysisModel v) =>
      v.progressSummary;
  static const Field<MilestoneAnalysisModel, String> _f$progressSummary =
      Field('progressSummary', _$progressSummary);
...
mixin MilestoneAnalysisModelMappable {
  ...
  MilestoneAnalysisModelCopyWith<MilestoneAnalysisModel, MilestoneAnalysisModel,
          MilestoneAnalysisModel>
      get copyWith => _MilestoneAnalysisModelCopyWithImpl<
              MilestoneAnalysisModel, MilestoneAnalysisModel>(
          this as MilestoneAnalysisModel, $identity, $identity);
  @override
  String toString() {
    return MilestoneAnalysisModelMapper.ensureInitialized()
        .stringifyValue(this as MilestoneAnalysisModel);
  }

  @override
  bool operator ==(Object other) {
    return MilestoneAnalysisModelMapper.ensureInitialized()
        .equalsValue(this as MilestoneAnalysisModel, other);
  }

  @override
  int get hashCode {
    return MilestoneAnalysisModelMapper.ensureInitialized()
        .hashValue(this as MilestoneAnalysisModel);
  }
}
...
extension MilestoneAnalysisModelValueCopy<$R, $Out>
  ...
  MilestoneAnalysisModelCopyWith<$R, MilestoneAnalysisModel, $Out>
      get $asMilestoneAnalysisModel => $base.as((v, t, t2) =>
          _MilestoneAnalysisModelCopyWithImpl<$R, $Out>(v, t, t2));
}
...
abstract class MilestoneAnalysisModelCopyWith<
  ...
  ListCopyWith<
      ...
      MilestoneInsightModelCopyWith<$R, MilestoneInsightModel,
          MilestoneInsightModel>> get milestones;
...
class _MilestoneAnalysisModelCopyWithImpl<$R, $Out>
  ...
  ListCopyWith<
      ...
      MilestoneInsightModel,
      MilestoneInsightModelCopyWith<$R, MilestoneInsightModel,
          MilestoneInsightModel>> get milestones => ListCopyWith(
      $value.milestones,
...
class MilestoneTrendsModelMapper extends ClassMapperBase<MilestoneTrendsModel> {
  ...
  static const Field<MilestoneTrendsModel, List<String>> _f$improving =
      Field('improving', _$improving);
  static List<String> _$stable(MilestoneTrendsModel v) => v.stable;
  static const Field<MilestoneTrendsModel, List<String>> _f$stable =
      Field('stable', _$stable);
  static List<String> _$concerning(MilestoneTrendsModel v) => v.concerning;
  static const Field<MilestoneTrendsModel, List<String>> _f$concerning =
      Field('concerning', _$concerning);
...
mixin MilestoneTrendsModelMappable {
  ...
  MilestoneTrendsModelCopyWith<MilestoneTrendsModel, MilestoneTrendsModel,
      MilestoneTrendsModel> get copyWith => _MilestoneTrendsModelCopyWithImpl<
          MilestoneTrendsModel, MilestoneTrendsModel>(
      this as MilestoneTrendsModel, $identity, $identity);
  @override
  String toString() {
    return MilestoneTrendsModelMapper.ensureInitialized()
        .stringifyValue(this as MilestoneTrendsModel);
  }

  @override
  bool operator ==(Object other) {
    return MilestoneTrendsModelMapper.ensureInitialized()
        .equalsValue(this as MilestoneTrendsModel, other);
  }

  @override
  int get hashCode {
    return MilestoneTrendsModelMapper.ensureInitialized()
        .hashValue(this as MilestoneTrendsModel);
  }
}
...
class _MilestoneTrendsModelCopyWithImpl<$R, $Out>
  ...
  @override
  ListCopyWith<$R, String, ObjectCopyWith<$R, String, String>> get improving =>
      ListCopyWith($value.improving, (v, t) => ObjectCopyWith(v, $identity, t),
          (v) => call(improving: v));
  @override
  ListCopyWith<$R, String, ObjectCopyWith<$R, String, String>> get stable =>
      ListCopyWith($value.stable, (v, t) => ObjectCopyWith(v, $identity, t),
          (v) => call(stable: v));
  @override
  ListCopyWith<$R, String, ObjectCopyWith<$R, String, String>> get concerning =>
      ListCopyWith($value.concerning, (v, t) => ObjectCopyWith(v, $identity, t),
          (v) => call(concerning: v));
  @override
  $R call(
          {List<String>? improving,
