...
class _ClinicSelectionScreenState extends State<ClinicSelectionScreen> {
  ...
  Future<void> _checkExistingClinic() async {
    try {
      ...
      if (patientResponse != null && patientResponse['clinic_id'] != null) {
        ...
        _existingClinicId = patientResponse['clinic_id'] as String;
  ...
  Future<void> _saveClinicSelection() async {
    ...
    try {
      // Update patient record with clinic_id
      await _supabase
          .from('patient')
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Clinic selected successfully!'),
              ...
              children: [
                ...
                Text(
                  _hasExistingClinic
                      ...
                      : 'Select the clinic you are associated with. This helps us provide you with the right services. Once selected, you cannot change it without admin approval.',
          ...
          if (!_hasExistingClinic)
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: FilledButton(
                  onPressed: () {
                    // Navigate to next screen (assessments or home)
                    Navigator.of(context).pushReplacement(
                      MaterialPageRoute(
                        builder: (context) => const AssessmentsListScreen(),
                      ),
