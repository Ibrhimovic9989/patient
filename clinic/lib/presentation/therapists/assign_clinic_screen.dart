...
class AssignClinicScreen extends StatefulWidget {
  final String therapistId;
  final String therapistName;

  const AssignClinicScreen({
    super.key,
  ...
  @override
  State<AssignClinicScreen> createState() => _AssignClinicScreenState();
}

class _AssignClinicScreenState extends State<AssignClinicScreen> {
  ...
  Future<void> _assignClinic() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Therapist assigned to clinic successfully')),
        );
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Assign clinic to ${widget.therapistName}',
