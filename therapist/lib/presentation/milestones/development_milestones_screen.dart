...
import 'package:therapist/provider/milestones_provider.dart';
...
class DevelopmentMilestonesScreen extends StatelessWidget {
  ...
  const DevelopmentMilestonesScreen({
    super.key,
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              context.read<MilestonesProvider>().analyzeMilestones(patientId);
            },
          ),
        ],
      ),
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      provider.analyzeMilestones(patientId);
                    },
            ...
            child: Column(
              ...
              children: [
                ...
                if (analysis.milestones.isNotEmpty) ...[
                  ...
                  const SizedBox(height: 8),
                  ...analysis.milestones.map((milestone) => _buildMilestoneCard(milestone)),
                  const SizedBox(height: 16),
                ],
  ...
  Widget _buildMilestoneCard(MilestoneInsightModel milestone) {
    Color statusColor;
    IconData statusIcon;
